...
ax1.plot(range(1966,2013),seasonly[2],'-')
...
ax1.legend(["Hail","Riyadh"],loc='upper left',fontsize=fontsize)#"Hail"
ax1.plot((1965.5, 1965.5), (-10, 70), 'k--',linewidth=3)
ax1.plot((1977.5, 1977.5), (-10, 70), 'k--',linewidth=3)
ax1.plot((1979.5, 1979.5), (-10, 70), 'k--',linewidth=3)
