...
wada=open("Wada_timeseries.txt","r")
...
ax1.plot(range(1966,2013),seasonly[0],'-')
ax1.plot(range(1966,2013),seasonly[1],'-')
######################
...
ax1.set_ylabel("Rainfall (mm/month)",fontsize=fontsize)
ax1.tick_params(labelsize=fontsize)
ax1.set_xticks(range(1966,1996,4))
ax1.set_xlim([1966,1996])
ax1.legend(["Qaseem","Riyadh"],loc='upper left',fontsize=fontsize)#"Hail"
ax1.plot((1965.5, 1965.5), (-20, 100), 'k--',linewidth=3)
ax1.plot((1977.5, 1977.5), (-20, 100), 'k--',linewidth=3)
ax1.plot((1979.5, 1979.5), (-20, 100), 'k--',linewidth=3)
