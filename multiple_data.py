...
79:1980 
print("GPCC")
print(np.average(FMAM[83:92]))
print(np.average(FMAM[99:len(FMAM)]))
print(np.var(FMAM[83:92]))
print(np.var(FMAM[99:len(FMAM)]))
#####################
...
####################
#Fil=nc.MFDataset("/home/L.r02229011/data_plotting/PRECL.mon.mean.0.5x0.5.nc")
#clat=np.array(Fil.variables['lat'])
#clat=np.cos(clat*4.0*np.arctan(1.0)/180.0)
...
#print("PREC/L")
#print(np.average(FMAM[36:45]))
#print(np.average(FMAM[52:len(FMAM)]))
#print(np.var(FMAM[36:45]))
#print(np.var(FMAM[52:len(FMAM)]))
########################
...
#ax1.legend(["GPCC","CRU","GPCP","PREC/L","CPC-U"],loc='upper right')
